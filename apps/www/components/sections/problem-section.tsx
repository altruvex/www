  ...
  return (
    ...
    >
      <div className="flex items-start">
        <span
          className="font-mono text-[clamp(2rem,4vw,3rem)] font-medium leading-none tracking-[-0.02em] text-foreground/60 transition-all duration-300 group-hover:text-foreground/90"
          aria-hidden="true"
        >
          {item.number}
        </span>

          ...
          <div ref={testimonialsRef} className="mt-10 grid gap-0 border-t border-s border-e border-border md:grid-cols-2">
            {testimonials.map((item) => (
              ...
              >
                ...
                <figcaption className="mt-5 font-mono text-sm leading-normal tracking-wider uppercase rtl:font-sans rtl:normal-case rtl:tracking-normal text-muted-foreground">

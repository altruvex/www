                                ...
                                <div className="pt-6 sm:pt-8">
                                    <div className="flex flex-col sm:flex-row gap-4">
                                        <Link href="/schedule" className="flex-1 sm:flex-none">
                                            <MagneticButton size="lg" className="w-full group relative">
                                        ...
                                        <a href={`https://wa.me/${t("phoneValue").replace(/\D/g, "")}`} target="_blank" rel="noopener noreferrer" className="flex-1 sm:flex-none">
                                            <MagneticButton size="lg" className="w-full group relative bg-messaging-whatsapp text-white hover:bg-messaging-whatsapp/90 border-transparent">
                                                <span className="flex items-center gap-2">

  ...
  return (
    <div
      className={cn(
        ...
        isOpen
          ? "border-foreground/20 bg-foreground/3 shadow-md"
    ...
    >
      ...
      >
        <div className="overflow-hidden">
          <div className="px-6 pb-6 pt-2 border-t border-foreground/5 ml-13">
            <p className="text-foreground/70 text-sm md:text-base leading-relaxed whitespace-pre-wrap">
              {answer}
            </p>
          </div>
        </div>

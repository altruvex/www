            ...
            <div ref={tierCardsRef} className="grid gap-4 md:grid-cols-2 lg:grid-cols-5 mb-16">
              {tiers.map((tier, i) => (
                ...
                >
                  ...
                  {tier.notIncluded && (
                    <p className="text-[10px] text-primary/35 leading-relaxed mb-6 border-t border-foreground/8 pt-4">
                      {tier.notIncluded}
                    </p>
                  )}
                  <p className="text-[10px] text-primary/75 leading-relaxed mb-4">
                    {tier.nextStep}
                  </p>
                  <MagneticButton

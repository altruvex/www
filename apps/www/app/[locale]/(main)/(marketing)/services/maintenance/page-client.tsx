        ...
        <div className="grid md:grid-cols-12 gap-4">
          ...
          <div ref={rightRef} className="md:col-span-5 grid grid-cols-2 gap-3">
            {stats.map((stat, i) => (
              <div
                key={i}
                className="border border-foreground/8 rounded-lg bg-foreground/2 p-5 md:p-6 flex flex-col justify-between group hover:bg-foreground/4 transition-all duration-300"
              >
        ...
        <div className="grid md:grid-cols-6 gap-4">
          {features.map((feature, i) => (
            <div
              ...
              data-feature-card
              className={[
                "group relative border border-foreground/8 rounded-lg bg-foreground/2 p-6 md:p-8 overflow-hidden hover:bg-foreground/4 transition-all duration-300",

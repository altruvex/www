...
import { UIPlaygroundSection } from "@/components/sections/ui-playground-section";
        ...
        >
          {showcaseItems.map((item, i) => (
            <div
              ...
              data-showcase-item
              className={[
                "group relative border border-foreground/8 rounded-lg bg-foreground/2 p-6 md:p-8 overflow-hidden flex flex-col justify-between hover:bg-foreground/4 transition-all duration-300 cursor-pointer",
                getSpan(i),
              ].join(" ")}
            >
              <div
              ...
              <div className="relative z-10 flex items-start justify-between">
                ...
                <span className="font-mono text-sm text-muted-foreground opacity-0 transition-all duration-300 ease-out group-hover:-translate-y-0.5 ltr:group-hover:translate-x-0.5 rtl:group-hover:-translate-x-0.5 group-hover:opacity-100 rtl:inline-block rtl:-scale-x-100">
                  ↗
                </span>
              </div>
              <div className="relative z-10 mt-auto">
                <h3
                  className="font-sans font-medium text-primary group-hover:text-primary/80 transition-all duration-300"
                  style={{
                    fontSize:
                      i === 0
...
const FeatureCard = ({
  ...
  return (
    <div
      className={cn(
        "feature-card-anim group relative border-b border-foreground/10 transition-all duration-500 hover:bg-foreground/2",
        isHero ? "border-t" : ""
      )}
    >
      <div
      ...
      >
        <div className="flex items-center gap-4 shrink-0 w-32">
          ...
          <span className="font-mono text-[13px] tracking-[0.25em] uppercase text-foreground/40 group-hover:text-foreground/70 transition-all duration-500">
            SYS // {feature.num}
          </span>
        </div>
  ...
  return (
    ...
    >
      <Container>
        ...
        <div className="flex flex-col relative before:absolute before:-start-4 before:top-0 before:bottom-0 before:w-px before:bg-foreground/5">

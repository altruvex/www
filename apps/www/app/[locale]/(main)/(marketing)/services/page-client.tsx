                ...
                >
                  <div className="relative z-10 h-full flex flex-col justify-between">
                    ...
                    <div className="mt-8 flex items-center justify-between">
                      ...
                      <div className="size-11 flex items-center justify-center rounded-full border border-border bg-background transition-all duration-300 ease-out group-hover:bg-foreground group-hover:text-background">
                        <ArrowIcon className="size-5 transition-all duration-300 ease-out ltr:group-hover:translate-x-0.5 rtl:group-hover:-translate-x-0.5 group-hover:-translate-y-0.5" />
                      </div>
                    </div>
                  </div>
                </Link>
      ...
      <div className="relative z-2 flex flex-col gap-8 h-full pointer-events-none">
        ...
        <div className="mt-6 pt-8 border-t border-border flex flex-col sm:flex-row sm:items-center justify-between gap-8">
          ...
          <div className="relative z-3 flex items-center gap-4 pointer-events-auto">
            ...
            <span
              aria-hidden
              className="size-12 flex items-center justify-center rounded-full bg-background border border-border transition-all duration-300 ease-out group-hover:bg-foreground group-hover:text-background group-hover:border-foreground"
            >
              <ArrowIcon className="size-5 transition-all duration-300 ease-out ltr:group-hover:translate-x-0.5 rtl:group-hover:-translate-x-0.5 group-hover:-translate-y-0.5" />
            </span>
          </div>

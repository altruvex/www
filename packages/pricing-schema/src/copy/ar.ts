...
export const AR_COPY: PricingCopy = {
  ...
  maintenanceTemplates: {
    requestCap:
      "حتى {count} طلبات تعديل شهرياً (تبديل محتوى أو صور، تعديلات بسيطة على الأقسام)",
    requestCapPriority:
  ...
  addons: {
    ...
    "managed-bundle": {
      ...
      description:
        "تتبع التجديدات وفاتورة موحدة للنطاق والاستضافة والبريد المؤسسي.",
    },
  },
  terms: {
    vatLabel: "ضريبة القيمة المضافة",
    vatNote:
      "جميع أرقام المشاريع مذكورة دون ضريبة القيمة المضافة. تُضاف الضريبة بنسبة {rate}% في مرحلة العقد.",
    revisionLabel: "سعر المراجعة",
    revisionNote:
      "تشمل {rounds} جولات مراجعة. أي مراجعة إضافية تُحتسب بـ{rate} جنيه/ساعة.",
    usdLabel: "سعر الدولار",
    usdNote:
      "تُحوَّل أرقام الدولار بسعر ثابت {rate} جنيه للدولار، يُراجع ربع سنوياً. آخر مراجعة {reviewedOn}.",
    addonLabel: "بنود التمرير",
    addonNote:
      "النطاق والاستضافة والبريد المؤسسي تُحتسب بما ندفعه، زائد هامش معلن. كل بند يظهر في سطر مستقل — ولا يُدمج أبداً في إجمالي المشروع.",
